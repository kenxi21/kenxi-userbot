...
class InlineBotManager:
    ...
    def create_category_menu(self, category_name, commands_list, back_callback="back_to_main"):
        buttons = []
        row = []
        ...
        async def callback_handler(client, callback_query):
            ...
            if data == "close":
                ...
                if callback_query.from_user.id != owner_id:
                    await callback_query.answer("❌ Only owner can close this menu!", show_alert=True)
                    return
            ...
            if data.startswith("cmd_"):
                if data in HELP_TEXTS:
                    category_map = {
                        "cmd_ping": "help_basic", "cmd_alive": "help_basic",
                        "cmd_help": "help_basic", "cmd_status": "help_basic",
                        "cmd_cekid": "help_basic", "cmd_stop": "help_basic",
                        "cmd_restart": "help_basic",
                        
                        "cmd_dspam": "help_spam", "cmd_fwd": "help_spam",
                        "cmd_scangroups": "help_spam", "cmd_listgroups": "help_spam",
                        "cmd_jaseball": "help_spam", "cmd_gcast": "help_spam",
                        "cmd_gucast": "help_spam",
                        
                        "cmd_kick": "help_admin", "cmd_ban": "help_admin",
                        "cmd_mute": "help_admin", "cmd_unmute": "help_admin",
                        "cmd_zombie": "help_admin", "cmd_tagall": "help_admin",
                        
                        "cmd_gemini": "help_ai", "cmd_gpt": "help_ai",
                        "cmd_claude": "help_ai", "cmd_perplexity": "help_ai",
                        
                        "cmd_dl": "help_media", "cmd_kang": "help_media",
                        "cmd_toimg": "help_media"
                    }
                    
                    back_to = category_map.get(data, "back_to_main")
                    
                    back_button = InlineKeyboardMarkup([
                        [InlineKeyboardButton("⬅️ Back to Category", callback_data=back_to)],
