...
class InlineBotManager:
    ...
    def get_help_content(self):
        text = (
            ...
            "Silakan pilih kategori fitur di bawah ini untuk melihat detail perintahnya:"
        )
        markup = InlineKeyboardMarkup([
            [
            ...
            [
                ...
                InlineKeyboardButton("🎬 Anim", callback_data="cat_anim")
            ],
            [
    ...
    def get_anim_help(self):
        text = "🎬 **ANIMATION MENU**\nPilih kategori animasi:"
        btns = [
    ...
    def back_to(self, cat):
        return InlineKeyboardMarkup([[InlineKeyboardButton("⬅️ Back", callback_data=f"cat_{cat}")]])
